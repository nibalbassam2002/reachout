...
.btn-export:hover { background: var(--navy-light); color: #fff; }
...
.priority-dot.low    { color: var(--green); }
.priority-dot.low::before    { background: var(--green); }
.priority-dot.medium { color: var(--amber); }
.priority-dot.medium::before { background: var(--amber); }
.priority-dot.high   { color: var(--red); }
.priority-dot.high::before   { background: var(--red); }
.priority-dot.crisis { color: var(--crisis); }
.priority-dot.crisis::before { background: var(--crisis); }
...
@media (max-width: 768px) {
    .cases-table thead th:nth-child(5),
    .cases-table tbody td:nth-child(5) { display: none; }
}
</style>
...
<div class="cases-table-wrap">
    <table class="cases-table" id="casesTable">
        ...
        <tbody>
            ...
            @endphp
            <tr onclick="window.location='{{ route('admin.cases.show', $case->id) }}'" style="cursor:pointer">
                <td><span class="ref-num">{{ $case->case_number }}</span></td>
                <td>
                    <div class="child-cell">
                        <div>
                            <div class="child-cell-name">{{ $case->child_name }}</div>
                            <div class="child-cell-meta">Age {{ $case->child_age }}
                ...
                <td>
                    <span class="priority-dot {{ $case->priority }}">{{ ucfirst($case->priority) }}</span>
                </td>
                <td>
                    @php
